...
- Deterministic first: the main baseline stays runnable without model credentials, while optional `answered`-path LLM synthesis remains additive rather than mandatory.
...
- no mandatory external model provider dependency for the main support chain
